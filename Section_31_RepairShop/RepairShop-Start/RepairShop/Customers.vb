Public Class Customers
    Private adapter As New RsDbDataSetTableAdapters.CustomersTableAdapter
    Public Shared LastError As String
    Dim origCustomerRow As RsDbDataSet.CustomersRow
    ...
    Public Function FindById(custId As Short) As RsDbDataSet.CustomersRow
        Dim table As DataTable = adapter.FindById(custId)
        Return CType(table.Rows(0), RsDbDataSet.CustomersRow)
    End Function
    ...
    Public Function Delete(custId As Short) As Boolean
        ...
        If MessageBox.Show("Delete Customer?", "Delete Customer?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then
