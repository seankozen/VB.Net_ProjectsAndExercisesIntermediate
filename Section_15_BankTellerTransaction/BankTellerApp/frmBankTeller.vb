...
Public Class frmBankTeller
    ...
    Private Sub btnTransLog_Click(sender As Object, e As EventArgs) Handles btnTransLog.Click

        transactions.Save()
        frmTransactions.lstTransactions.Items.Clear()

        For Each trans As Transaction In transactions.Items
            frmTransactions.lstTransactions.Items.Add(trans.ToString())
        Next
