...
Namespace KarateDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As KarateDataSet.MembersDataTable, ByVal date_joined As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function SelectByDate(ByVal date_joined As Global.System.Nullable(Of Date)) As KarateDataSet.MembersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (date_joined.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(date_joined.Value,Date)
            Else
