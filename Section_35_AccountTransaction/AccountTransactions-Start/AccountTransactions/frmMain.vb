Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim acct1 As New SavingsAccount("007", "George,Banana", 2500, 0.04)
        Dim acct2 As New SavingsAccount("C3P0", "Lucas, George", 10000000, 0.028)
    ...
    Private Sub lstAccounts_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstAccounts.SelectedIndexChanged
        ...
        Try
            Dim id As String = lstAccounts.SelectedItem.ToString().Split(" , ")(0)
