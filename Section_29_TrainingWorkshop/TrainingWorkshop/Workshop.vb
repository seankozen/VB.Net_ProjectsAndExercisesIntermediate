Public Class Workshop
    ...
    Public ReadOnly Property Categories As DataTable
        Get
            Return categoriesAdapter.GetData()
        End Get
    End Property
    ...
    Public Function Update(id As Short, categoryId As Short, days As Short, cost As Decimal, description As String) As Boolean

        Dim origData As TrainingDataSet.WorkshopsRow
        origData = FindById(id)



        Return adapter.Update(id, categoryId, days, cost, description, origData.Id, origData.CategoryId, origData.NumOfDays, origData.Cost, origData.Title)
    End Function
